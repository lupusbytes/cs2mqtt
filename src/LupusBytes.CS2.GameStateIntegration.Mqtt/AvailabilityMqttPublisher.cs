    ...
    IMqttClient mqttClient) : GameStateObserverService(gameStateService)
{
    ...
    private readonly HashSet<SteamId64> onlinePlayerMatchStatsStates = [];
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
        => Task.WhenAll(
            ...
            ProcessChannelAsync(PlayerMatchStatsChannelReader, onlinePlayerMatchStatsStates, PlayerMatchStatsAvailabilityTopicSuffix, stoppingToken),
    ...
    private Task SetAllOffline(CancellationToken cancellationToken)
    {
        ...
        var entries = onlinePlayers.Select(steamId => (steamId, PlayerAvailabilityTopicSuffix))
            ...
            .Concat(onlinePlayerMatchStatsStates.Select(steamId => (steamId, PlayerMatchStatsAvailabilityTopicSuffix)))
