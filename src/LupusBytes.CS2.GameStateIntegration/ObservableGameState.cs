    ...
    IObservable<StateUpdate<PlayerMatchStats>>
{
    ...
    protected ISet<IObserver<StateUpdate<PlayerMatchStats>>> PlayerMatchStatsObservers { get; } = new HashSet<IObserver<StateUpdate<PlayerMatchStats>>>();
    ...
    public IDisposable Subscribe(IObserver<StateUpdate<PlayerMatchStats>> observer)
        => Subscribe(PlayerMatchStatsObservers, observer);
